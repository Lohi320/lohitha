...
# Calling UI Elements
accountNumberLable = Label(root, text="Enter Card  Number")
accountNumberInput = Entry(root, width=50, borderwidth=2)
accountPinLable = Label(root, text="Enter Card  Pin")
...
loadImg = Button(root, text="Select Face Image", width=20, height=2, bg="#2d5cf7", fg="white", command=load)
submitButton = Button(root, text="Enter", width=20, height=2, bg="#2d5cf7", fg="white", command=insert)
